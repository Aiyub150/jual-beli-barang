...
if(isset($_GET['id'])){
    $nofaktur = $_GET['id'];
    $sql = "SELECT * FROM jual WHERE nofaktur='$nofaktur'";
    $data = $conn->query($sql);
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "UPDATE jual SET tgl='$tgl', kodebrg='$kodebrg', qty='$qty' WHERE nofaktur='$nofaktur'";
...
<body>
    ...
    <div class="content">
    <h2>Ubah Data Jual Nomor Faktur <?php echo $nofaktur ?></h2>
